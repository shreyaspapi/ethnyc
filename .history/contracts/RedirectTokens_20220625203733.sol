...
contract RedirectTokens is SuperAppBase, Ownable {
    ...
    constructor(
        ...
        ownershipToken = address(burnMintToken.initialize("Lev super aWETH", "levAWETH", 0x2C90719f25B10Fc5646c82DA3240C76Fa5BcCF34, 0, address(this), ""));
    ...
    function distributeTokens() external {
        ...
        // call IDA
        _ida.createIndex(ownershipToken, );
