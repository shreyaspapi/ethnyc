...
contract RedirectTokens is SuperAppBase, Ownable {
    ...
    // we need a third token here which is our custom token?
    // the token contract will need to have ownership by this contract
    // so we can mint and burn tokens in 
    IERC20 private ownershipToken;
    ...
    function distributeTokens() external {
        ...
        // Now we want to get all of the address and send them some shares
    ...
    function reclaimTokens() external {
        ...
        uint256 amountRepaid = aave.repay(eth, total_in, 2, address(this));
