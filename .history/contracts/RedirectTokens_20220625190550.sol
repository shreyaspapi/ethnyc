...
contract RedirectTokens is SuperAppBase, Ownable {
    ...
    function distributeTokens() external {
        ...
        for (uint i = 0; i < streamAddressesToken1.length; i++) {
            ...
            amount
            flowRate
            uint256 amount((block.timestamp-addressToStreamInfo[_shareholder].timestamp)*addressToStreamInfo[_shareholder].flowRate + addressToStreamInfo[_shareholder].amount)
